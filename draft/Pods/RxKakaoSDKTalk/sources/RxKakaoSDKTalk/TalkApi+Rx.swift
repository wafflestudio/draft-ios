...
extension Reactive where Base: TalkApi {
    ...
    public func profile(secureResource: Bool = true) -> Single<TalkProfile> {
        return auth.rx.responseData(.get, Urls.compose(path:Paths.talkProfile), parameters: ["secure_resource": secureResource].filterNil())
...
//    }
    ...
    public func friends(offset: Int? = nil,
                        limit: Int? = nil,
                        order: Order? = nil,
                        secureResource: Bool = true) -> Single<Friends<Friend>> {
