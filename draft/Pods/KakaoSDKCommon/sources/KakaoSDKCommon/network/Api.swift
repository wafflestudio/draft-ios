...
extension Api {
    ...
    public func responseData(_ HTTPMethod: Alamofire.HTTPMethod,
        ...
        Api.shared.session(sessionType)
            .request(url, method:HTTPMethod, parameters:parameters, encoding:Api.shared.encoding, headers:(headers != nil ? HTTPHeaders(headers!):nil) )
